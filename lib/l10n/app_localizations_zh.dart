...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get onboardingScreenOneTitle => '欢迎使用 Call Tracker !';
  ...
  String get storagePolicyText =>
      '此应用会临时存储生成的文件, 并在退出时将其删除。您可以将通话记录下载到您选择的位置。Call Tracker 仅访问通话记录，确保您的隐私。';
  ...
  String get appPermissionsDeniedError =>
      '哎呀！似乎访问通话记录被拒绝了。为了确保 Call Tracker 正常工作，请授予权限。';
  ...
  @override
  String get appDetailsSubText => '版本 • 错误报告';
