...
abstract class AppLocalizations {
  ...
  /// Subtitle for the first onboarding screen, introducing Call Tracker as a call log management and analysis app.
  ///
  /// In en, this message translates to:
  /// **'Your go-to app for managing and analyzing your call logs effortlessly.'**
  String get onboardingScreenOneSubtitle;

  /// Title for the first onboarding screen welcoming the user to Call Tracker.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'This app temporarily stores generated files, deleting them on exit. You can download call logs to your chosen location. Call Tracker only accesses call logs, ensuring your privacy.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Uh-oh! It seems like access to call logs has been denied. To ensure Call Tracker works smoothly, please grant permission. '**
