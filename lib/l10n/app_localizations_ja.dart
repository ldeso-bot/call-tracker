...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get onboardingScreenOneTitle => 'Contact Logへようこそ!';
  ...
  String get storagePolicyText =>
      'このアプリは、生成されたファイルを一時的に保存し、終了時に削除します。選択した場所に通話ログをダウンロードできます。Contact Logは通話ログにのみアクセスし、プライバシーを保護します。';
  ...
  String get appPermissionsDeniedError =>
      'おっと! 通話ログへのアクセスが拒否されたようです。Call Tracker をスムーズに動作させるには、権限を許可してください。';
  ...
  @override
  String get appDetailsSubText => 'バージョン • バグ報告';
