...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get onboardingScreenOneTitle => 'Contact Log에 오신 것을 환영합니다!';
  ...
  String get storagePolicyText =>
      '이 앱은 생성된 파일을 일시적으로 저장하며 종료 시 삭제합니다. 선택한 위치로 통화 기록을 다운로드할 수 있습니다. Contact Log는 통화 기록에만 액세스하여 개인 정보를 보호합니다.';
  ...
  String get appPermissionsDeniedError =>
      '앗! 통화 기록에 대한 액세스가 거부된 것 같습니다. Contact Log가 원활하게 작동하려면 권한을 허용해 주세요.';
  ...
  @override
  String get appDetailsSubText => '버전 • 버그 보고';
