...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get onboardingScreenOneTitle => 'Добро пожаловать в Call Tracker!';
  ...
  String get storagePolicyText =>
      'Это приложение временно хранит созданные файлы, удаляя их при выходе. Вы можете загрузить журналы вызовов в выбранное вами место. Call Tracker имеет доступ только к журналам вызовов, обеспечивая вашу конфиденциальность.';
  ...
  String get appPermissionsDeniedError =>
      'Ой! Похоже, доступ к журналам вызовов был запрещен. Чтобы Call Tracker работал бесперебойно, пожалуйста, предоставьте разрешение.';
  ...
  @override
  String get appDetailsSubText => 'Версия • Сообщить о баге';
  ...
  String get tracklistPlaceholderText =>
      'Эффективно управляйте своим списком отслеживания. Нажмите + (в правом верхнем углу), чтобы добавить контакт, проведите влево по элементу списка и нажмите Удалить, чтобы перестать отслеживать.';
